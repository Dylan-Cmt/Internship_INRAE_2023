...
# ╔═╡ 3ab1a6ac-7e98-470e-a1d5-aa4a35e596c3
# Paramétrisation

begin
	# initiale density of population
	x0 = 1.35
	etat0 = @SVector [x0]
...
# ╔═╡ d7916b26-8c12-4131-b4d7-ad95b9cb14b6
function model_allee(u, p, t)
    r, K, ϵ = p
    x = u[1]
    dx = r*x*(1- x/K)*(x/ϵ -1)
    @SVector [dx]
...
# ╔═╡ 8e78246a-1b66-446e-bd4d-1668019663b2
md"""
Pour mettre en valeur la bi-stabilité du système dynamique défini par l’équation, nous créons une fonction qui intègre le problème de Cauchy depuis une condition initiale donnée.
"""

# ╔═╡ 82515679-22c2-40e8-acf7-f604d46d0f0d
problem = ODEProblem(model_allee, etat0, tspan, params_allee)

# ╔═╡ 3e5b85ea-fa9e-415e-ab16-15b151114871
solution = solve(problem)

# ╔═╡ 8c8b7606-58c8-48c7-abd0-cc92cf5b5398
begin
	plot(solution, size=(500, 300), label="solution")

	
	# équilibres
	plot!(solution.t, zero(1:length(solution.t)),linestyle =  :dashdot,label = "équilibres stables",color="green")
	plot!(solution.t, ones(length(solution.t))*K,linestyle =  :dashdot,label=false,color="green")
	plot!(solution.t, ones(length(solution.t))*ϵ,linestyle =  :dashdot,label = "équilibre instable",color="red")		
end
